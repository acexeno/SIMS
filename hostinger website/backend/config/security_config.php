...
function getContentSecurityPolicy() {
    ...
    if (isProduction()) {
        // Allow 'unsafe-inline' for scripts to support reCAPTCHA config and other inline scripts
        // This is necessary for the reCAPTCHA site key configuration
...
function applySecurityConfiguration() {
    ...
    // Ensure we override any default CSP headers from the server
    $csp = getContentSecurityPolicy();
    header('Content-Security-Policy: ' . $csp, true); // true = replace existing header

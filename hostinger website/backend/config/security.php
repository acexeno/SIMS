...
function setSecurityHeaders() {
    ...
    // Content Security Policy is now handled by security_config.php via applySecurityConfiguration()
    // This ensures consistent CSP across the application and prevents duplicate headers
    // The CSP from security_config.php includes 'unsafe-eval' for compatibility with React/Vite

        ...
        <div className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">PC Assembly - Super Admin</h1>
                <p className="text-xs sm:text-sm text-gray-600">Create prebuilts directly</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <div className="px-2 sm:px-3 py-1 bg-red-100 text-red-800 rounded-full text-xs sm:text-sm font-medium">Super Admin Access</div>
            </div>
          </div>
        </div>
      </div>
